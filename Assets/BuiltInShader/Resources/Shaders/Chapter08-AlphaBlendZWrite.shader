//Chapter08_透明度混合_开启ZWrite
Shader "Unity Shaders Book/Chapter08-Alpha Blend ZWrite"
{
    Properties
    {
        //基础颜色
    ...
    SubShader
    {
        ...
        //该Pass仅处理ZWrite，使得物体能够有正确的选择顺序。下一个Pass再处理半透明问题。
        Pass
        {
            //开启深度写入
            ZWrite On
            //当该值为0时，不输出任何颜色。也就是该Pass只处理深度，不会输出颜色。
            ColorMask 0
        }
