...
//Chapter06_标准光照模型中的逐顶点高光计算
Shader "Unity Shaders Book/Chapter06-SpecularVertexLevel"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            v2f vert (a2v v)
            {
                ...
                //按照光照模型，要计算高光，需要4个入参：入射光线的颜色+强度+方向、材质的漫反射系数、表面法线
                //计算光线的反射光方向。reflect计算反射光，需要两个参数，光线入射方向+法线方向；之所以worldLight要取反，是因为需要从光源指向交点的。
